...
namespace Homework_9_2
{
    class Buy : Product
    {
        ...
        public Buy(string producer, string name, double price, double weight, int count) : base(producer, name, price, weight)
        {
            _product = new Product(producer, name, price, weight);
            Count = count;
