...
namespace Homework_8
{
    class DairyProducts : Product
    {
        ...
        public DairyProducts(string producer, string name, double price, double weight,
            DateTime from, DateTime to) : base(producer, name, price, weight)
        {
            From = from;
            To = to;
        ...
        {
            if (obj is not DairyProducts obj2 || !GetType().Equals(obj2.GetType()))
            {
                return false;
            }
            else
            {
                return base.Equals(obj2) && From == obj2.From && To == obj2.To;
            }
        }
